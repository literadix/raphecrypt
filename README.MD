![raphecrypt](docs/images/banner.png)

[![Rust](https://github.com/literadix/raphecrypt/actions/workflows/rust.yml/badge.svg?branch=main)](https://github.com/literadix/raphecrypt/actions/workflows/rust.yml)
[![Docker Image CI](https://github.com/literadix/raphecrypt/actions/workflows/docker-image.yml/badge.svg?branch=main)](https://github.com/literadix/raphecrypt/actions/workflows/docker-image.yml)
...
Every contribution helps keep the project maintained, documented, and available for everyone who needs a small, focused Unicode steganography tool. If `raphecrypt` saves you time, helps with a project, or simply feels useful, you can support its development here:

[![Fund raphecrypt on Buy Me a Coffee](https://img.shields.io/badge/Buy%20me%20a%20coffee-support%20raphecrypt-ffdd00?style=for-the-badge&logo=buymeacoffee&logoColor=000)](https://buymeacoffee.com/bednarzhani)
...
## Hosted Web App, fully functional

The static web app is deployed with GitHub Pages: https://literadix.github.io/raphecrypt/
...
![raphecrypt encode view](docs/images/encode.png)

### Decode

![raphecrypt decode view](docs/images/decode.png)

### Scan

![raphecrypt scan view](docs/images/scan.png)

## Quick Start

Download binaries and source code:

https://github.com/literadix/raphecrypt/releases/
...
By downloading, copying, building, running, or otherwise using this software,
you acknowledge and agree that you are solely responsible for using it in a
lawful manner and in compliance with all applicable local, regional, national,
and international laws and regulations.

This software may only be used for lawful purposes. You may not use this
software to create, hide, transmit, store, protect, encrypt, obfuscate, or
otherwise handle illegal content, unlawful communications, unauthorized data,
or any material whose creation, possession, transmission, concealment, or use is
illegal under applicable law.

The authors, contributors, and copyright holders do not endorse, encourage, or
authorize any illegal use of this software. You are solely responsible for any
content you process with this software and for any consequences resulting from
your use or misuse of it.

If you do not agree to these terms, do not download, copy, build, run, or use
this software.
...
```text
https://hub.docker.com/r/literadix/raphecrypt/tags
```

Pull the latest image:

```sh
docker pull literadix/raphecrypt:latest
```

Run the web app:

```sh
docker run --rm -p 8000:8000 literadix/raphecrypt:latest
```
...
The runtime image uses `scratch` and a statically linked Rust web server. It
does not include a package manager, shell, or Debian/Alpine runtime packages,
which keeps the deployable image small and minimizes OS-package CVE findings.

## GitHub Releases

The release workflow builds:

- `raphecrypt-linux-x86_64.tar.gz`
- `raphecrypt-macos-aarch64.tar.gz`
- `raphecrypt-windows-x86_64.zip`
- `raphecrypt-web-dist.zip`
...
You may use, copy, modify, and distribute the software, but the license does
not grant the right to sell the software or a product/service whose value
derives entirely or substantially from the functionality of this software. See
